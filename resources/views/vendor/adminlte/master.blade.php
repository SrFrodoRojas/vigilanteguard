...
<head>
    ...
    <!-- (podés dejar el de Apple por compatibilidad) -->
    ...
    <title>
        ...
        @yield('title', config('adminlte.title', 'Vigilante'))
        @yield('title_postfix', config('adminlte.title_postfix', ''))
    </title>

    {{-- PWA: manifest + color + apple icon --}}
    <link rel="manifest" href="{{ asset('manifest.json') }}">
    <meta name="theme-color" content="#dc408a">
    <meta name="apple-mobile-web-app-capable" content="yes">
...
<body class="@yield('classes_body')" @yield('body_data')>
    ...
    <script>
        (function() {
            ...
            const apply = () => document.body.classList.toggle('dark-mode', localStorage.getItem(key) === '1');
